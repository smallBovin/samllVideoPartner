...
- (void)addObservers
{
    ...
    [self.scrollView addObserver:self forKeyPath:MJRefreshKeyPathContentInset options:options context:nil];
...
- (void)removeObservers
{
    ...
    [self.superview removeObserver:self forKeyPath:MJRefreshKeyPathContentInset];
