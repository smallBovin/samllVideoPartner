...
//            [self.navigationController pushViewController:videoPlayerVc animated:YES];
            MBVideoEditingViewController *videoEditVC = [MBVideoEditingViewController new];
            videoEditVC.model = model;
...
//        [self pushPhotoPrevireViewController:photoPreviewVc];
        MBPhotoEditingViewController *photoEditVC = [MBPhotoEditingViewController new];
//        photoEditVC.view.backgroundColor = [UIColor blackColor];
        photoEditVC.model = model;
        __weak typeof(self) weakSelf = self;
        photoEditVC.doneButtonClickBlockCropMode = ^(UIImage * _Nonnull cropedImage, id  _Nonnull asset) {
            __strong typeof(weakSelf) strongSelf = weakSelf;
