...
/** 当前的旋转角度*/
@property (nonatomic, assign) CGFloat  rotationAngil;

@property (nonatomic, strong) UIImage *showStickerImage;
...
/** 移除时调用*/
@property (nonatomic, copy) void(^DeleteStickerComplete)(GYStickerView *sticker);
